package ba.bitcamp.snake.multiplayer;
...
public class SnakeMultiplayer extends JPanel {
	...
	private void Draw(Graphics g) {
		...
		for (int i = 0; i < size2; i++) {
			...
			if (i == 0) {
				...
				g.setColor(Color.BLUE);
				g.setFont(new Font("Sans Serif", Font.BOLD, 15));
				g.drawString("Score: " + score2, 730, 15);
	...
	private void eatedFood() {
		...
		// If snake 1 eates food, it will be extended, and score will be
		...
		if ((snakeX[0] == foodX) && (snakeY[0] == foodY)) {
			...
			// If snake 2 eates food, it will be extended, and score will be
			// increased. Every fifth bite, score will be increased by 25.
